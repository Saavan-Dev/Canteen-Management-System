...
<li>
        ...
        <!-- add name in the span tag  -->
            ...
            <h6>Modification of user Details...</h6>
           <form action="#" method="post">
						...
						<div class="form-group">
							<label>Enter the id of User what You want to Update</label>
							<input type="text" class="form-control" name="id" placeholder=""
								required="">
						</div>
						<button type="submit" class="btn submit mb-4" name="submit">Update</button>
					</form>
