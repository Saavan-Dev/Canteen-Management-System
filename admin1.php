...
<body>
    <div class="wrapper">
        ...
        <!-- add name in the span tag  -->
            ...
            <h6>WELCOME TO FOOD ORDERING SYSTEM</h6>
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-none d-md-block">
          <h5>Tasty Burgers</h5>
          <p>Doubled up with Cheez!!</p>
        </div>
      </div>
      <div class="carousel-item">
        <img src="../images/g2.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>Dilicious Food Ever..</h5>
          <p>Served with freash Vegitables..</p>
        </div>
      </div>
      <div class="carousel-item">
        <img src="../images/g3.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>Fresh Delights</h5>
          <p>With a great Hunger of Yours ;)</p>
        </div>
      </div>
    </div>
